  ...
  <div class="manage">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="submit" type="success" round>+确 定</el-button>
      </span>
    </el-dialog>
    <div class="manage-header">
      <el-button @click="handleAdd" type="success" round> +新增 </el-button>
      <!-- form的搜索区域 -->
      <el-form :inline="true" :model="userForm">
        ...
        <el-form-item>
          <el-button @click="onSubmit" type="success" round>查询</el-button>
        </el-form-item>
      </el-form>
    </div>
